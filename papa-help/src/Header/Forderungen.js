...
export default class Forderungen extends Component {
  render () {
    return (
      ...
      <Container>
       <Row>
       <Col md='12' className='Colpp'>
         <h3 className='h3'>Es darf nicht sein, dass die beschriebenen Verhältnisse, die einer Bananenrepublik gut anstehen würden, in der Schweiz weiterhin toleriert werden! Sie widersprechen jeglichen Grundsätzen der Familienrechts- sowie Sozialhilfegesetzgebung in diesem Land</h3>
         <br></br>
         <h3>Um diesen Zuständen eine Ende zu bereiten, fordere ich von den Politikern:</h3>
         <br></br>
         <br></br>
