          ...
          <Row>
            <Col md='12'>
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Väter-Studie der Commerzbank 2015</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Dokumente zum Thema weibliche Gewalt gegenüber Männern und Kindern</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Men being targets of intimate partner violence</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Geschlechtergewalt - Mythen, Tabus und Ideologie oder:
                  Solange es nur ein Mann ist!</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Väterlichkeit, Scheidung und Geschlechterkampf</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>Disabusing The Definition Of Domestic Abuse:
                  How Women Batter Men And The Role Of The Feminist State</strong>
                </h2>
              ...
              <div className='presse2'>
                <br />
                <h2>
                  <strong>The Battered Husband Syndrome</strong>
                </h2>
              ...
              <br />
              <h1 className='hh'>
                <strong>THE PARENTAL ALIENATION SYNDROME (PAS)</strong>
              </h1>
              <div className='presse3'>
                <br />
                <h2>
                  <strong>The Parental Alienation Syndrome (PAS)</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>Auswirkungen von PAS auf betroffene Eltern</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>Studie von Clawar & Riflin zur Elternentfremdung</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>PAS und die Interessenvertretung des Kindes</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>PAS, das Wohl und die Interessenvertretung des Kindes</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>Sollten Gerichte anordnen, dass an PAS leidende Kinder den entfremdeten Elternteil besuchen bzw. bei ihm wohnen?</strong>
                </h2>
              ...
              <div className='presse3'>
                <br />
                <h2>
                  <strong>PAS: Nicht instrumentalisieren lassen</strong>
                </h2>
